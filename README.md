...
<head>
    ...
    <style>
        ...
        input,
        select {
            width: 100%; /* Ajustado para 100% com box-sizing */
            padding: 10px;
            margin-top: 5px;
            border-radius: 6px;
            border: 1px solid #cbd5e1;
            font-size: 14px;
            box-sizing: border-box; /* Impede que o input saia da caixa */
        }
...
<body>
    <div class="menu">
        <div class="menu-esquerda"><strong>Escola</strong></div>
    ...
    <script>
        function MostrarDados(event) {
            ...
            // Opcional: rolar a página para ver o resultado
